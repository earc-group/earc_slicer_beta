...
$OpenGL::Config = {
                    ...
                    'DEFINE' => '-DHAVE_VER -DGL_VERSION_USED=2.1 -DHAVE_FREEGLUT -DHAVE_GL -DHAVE_GLU -DHAVE_GLX -DHAVE_FREEGLUT -DHAVE_FREEGLUT_H -DGL_GLEXT_LEGACY',
                    'EXE_FILES' => [],
                    'INC' => '-I/usr/include -I/usr/include -I/usr/X11R6/include -I/opt/X11/include -I/usr/local/include',
                    'LDFROM' => '$(OBJECT) ',
                    'LIBS' => '-L/usr/lib -L/usr/X11R6/lib -L/opt/X11/lib -L/usr/local/lib -lAGL.framework -lOpenGL.framework -lglut -lXext -lXmu -lXi -lICE -lX11 -lstdc++ -lm',
                    'META_MERGE' => {
