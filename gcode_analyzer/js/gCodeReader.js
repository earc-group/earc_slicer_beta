 ...
 */
 ...
 fs.readFile( __dirname + '/../output/output.gcode', function (err, data) {
  ...
  // console.log(data.toString());
   gcode_load_fs = data.toString();
   //console.log(gcode_load_fs);
 });

 // I know this shouldn't work but ti works so don't touch it plase :)
...
// ***** PUBLIC *******
    return {
        ...
        loadFile: function(reader){
            ...
            model = [];
            z_heights = [];
            detectSlicer(gcode_load_fs);
            //lines = reader.target.result.split(/\n/);
            lines = gcode_load_fs.split(/\n/);
            console.log("gcode_load_fs");
            console.log(gcode_load_fs);
