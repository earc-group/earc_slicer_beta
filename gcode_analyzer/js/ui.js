...
fs.readFile( __dirname + '/../output/output.gcode', function (err, data) {
          ...
          //console.log(data);
          var DataTransferItem = DataTransferItemList.add(data);
...
//                myCodeMirror.setValue(theFile.target.result);
    ...
    function load_file_fc() {

        evt = {};

        GCODE.gCodeReader.loadFile(evt);
...
//                var resultSet = [];
                ...
                //console.log(data.msg.printTime);
