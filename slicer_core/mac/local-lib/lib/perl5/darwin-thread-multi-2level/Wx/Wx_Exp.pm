...
wxIMAGELIST_DRAW_SELECTED
wxIMAGELIST_DRAW_FOCUSED) ];
$EXPORT_TAGS{'ipc'} = [ qw(wxIPC_UTF16TEXT
wxIPC_SYLK
wxIPC_RIFF
wxIPC_DIF
wxIPC_TEXT
...
wxEVT_COMMAND_RIBBONTOOL_CLICKED
wxEVT_COMMAND_RIBBONTOOL_DROPDOWN_CLICKED) ];
$EXPORT_TAGS{'ribbonart'} = [ qw(wxRIBBON_ART_GALLERY_BUTTON_ACTIVE_BACKGROUND_TOP_COLOUR
wxRIBBON_ART_GALLERY_BUTTON_FACE_COLOUR
wxRIBBON_ART_PANEL_HOVER_LABEL_BACKGROUND_COLOUR
wxRIBBON_ART_BUTTON_BAR_ACTIVE_BACKGROUND_COLOUR
wxRIBBON_ART_PAGE_HOVER_BACKGROUND_TOP_COLOUR
...
wxTREE_HITTEST_ONITEMLOWERPART
wxTREE_HITTEST_ONITEM) ];
$EXPORT_TAGS{'webview'} = [ qw(wxWEB_VIEW_ZOOM_TYPE_LAYOUT
wxWEB_VIEW_ZOOM_LARGE
wxWEB_NAV_ERR_NOT_FOUND
wxWEB_NAV_ERR_REQUEST
wxWEB_NAV_ERR_CERTIFICATE
